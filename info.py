...
URL = "https://host-ye6h.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://host-ye6h.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://host-ye6h.onrender.com/".format(FQDN)
else:
    URL = "https://host-ye6h.onrender.com/".format(FQDN)
